---
title: Municipios españoles con 2 nombres
author: Pedro J. Pérez
date: '2018-01-09'
slug: municipios-españoles-con-2-nombres
categories: []
tags: []
---
...
```{r}
library(knitr)
aa %>% kable("html", caption = "Cuadro 1: Municipios españoles con dos nombres oficiales (por CC.AA.)") %>%
...
#- tabla simple
aa %>% kable("html", caption = "Cuadro 2: Municipios españoles con dos nombres oficiales (por provincia)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
Para el que tenga curiosidad en ver exactamente que municipios son los que tienen dos nombres, lo puede hacer en el siguiente cuadro:
...
library(DT)
datatable(aa, caption = "Cuadro 3: Municipios con dos nombres oficiales",extensions = 'Scroller', options = list( pageLength = 10, deferRender = TRUE,scrollY = 400,scroller = TRUE), rownames = F, filter = "top" )
```
...
aa %>% kable("html", caption = "Cuadro 1a: Municipios españoles con \"dos nombres\" oficiales (por CC.AA.)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
aa %>% kable("html", caption = "Cuadro 2a: Municipios españoles con \"dos nombres\" oficiales (por provincias)") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
