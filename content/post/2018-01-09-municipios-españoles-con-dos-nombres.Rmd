...
Lo que pasa, es que Hugo (el programa que procesa el blog) parece que tiene problemas con los htmlwidgets y no se muestra la datatable. Una solución la explican [aquí](https://owi.usgs.gov/blog/leaflet/): hay que guardar la datatable en la carpeta `/static/`; yo lo he hecho en `/static/leaflet/DT_2_nombres_1.html y luego importarla en un iframe. A ver si lo consigo.
