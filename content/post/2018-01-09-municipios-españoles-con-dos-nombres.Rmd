...
```{r}
library(DT)
datatable(aa, extensions = 'Scroller', caption = "Cuadro 3: Municipios con dos nombres oficiales", options = list( pageLength = 10, deferRender = TRUE, scrollY = 400,scroller = TRUE), rownames = F, filter = "top" )
