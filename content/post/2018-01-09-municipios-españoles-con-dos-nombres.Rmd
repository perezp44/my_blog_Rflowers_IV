...
Lo que pasa, es que Hugo (el programa que procesa el blog) parece que tiene problemas con los htmlwidgets y no se muestra la datatable. Una solución la explican [aquí](https://owi.usgs.gov/blog/leaflet/): hay que guardar la datatable y luego importarla en un iframe. A ver si lo consigo.

```{r, eval = FALSE}
library(htmlwidgets)
library(htmltools)
saveWidget(DT_aa, "DT_2_nombres_1.html")
```

Una vez guradado la DT, hay que importarla con:
...
<iframe seamless src="/static/leaflet/DT_2_nombres_1/index.html" width="100%" height="500"></iframe>
