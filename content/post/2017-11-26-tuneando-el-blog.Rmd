...
- Para iniciar el blog: 
  ...
  - En RStudio crea un nuevo proyecto (WEb Site with Hugo). Has de poner el theme, yo he puesto `yoshiharuyamashita/blackburn` pero tiene pbs con los htmlwidget, así que pruebo el theme "hugo-tranquilpeak-theme" que lo has de poner como  `kakawait/hugo-tranquilpeak-theme`. Se lo ví a <https://aurora-mareviv.github.io/>
